                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr v-for="post in listPosts"  v-bind:id='"Post-"+ post.id'>
                                    <th class="col-md-1 text-center">@{{ post.id }}</th>
                                    <th class="col-md-2 text-center">@{{ post.title }}</th>
                                    ...
                                    <th class="col-md-2 text-center">
                                        <a v-bind:href="'/admin/post/'+ post.id +'/edit'" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </th>
                                </tr>
                            </table> 
                            <ul class="pagination">
