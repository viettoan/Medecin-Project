<footer>
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <ul>
                    ...
                    <li><i class="fa fa-clock-o">&nbsp;&nbsp;</i>Giờ làm việc: Thời gian làm việc: Sáng : 7-12h , chiều 13h30 - 19h, tất cả các ngày trong tuần.</li>
                    <li><i class="fa fa-volume-control-phone">&nbsp;&nbsp;</i>Liên hệ: 02433 868 309 - 09133 803 309</li>
                    <li><i class="fa fa-envelope-o">&nbsp;&nbsp;</i>Email: phongkhammika@gmail.com</li>
                </ul>
                {{-- <h6>
                    <i class="fa fa-phone-square">&nbsp;</i> TỔNG ĐÀI CHĂM SÓC KHÁCH HÀNG:
                    <h6><strong>02433 868 309 - 09133 803 309</strong></h6>
                </h6> --}}
            </div >
            <div class="col sm-3">
    ...
    <div class="row">
        ...
        <div class="nb-form">
            ...
            <p class="message">Số điện thoại liên hệ: <strong>02433 868 309 - 09133 803 309</strong></p>
